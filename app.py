...
model = YOLO(r'D:\Users\sachi\Traffic Detection\yolov8n.pt')

video = cv2.VideoCapture(r'D:\Users\sachi\Traffic Detection\traffic.mp4')
...
up_img = cv2.imread(r'D:\Users\sachi\Traffic Detection\up.png', cv2.IMREAD_UNCHANGED)
up_img = cv2.resize(up_img, (50, 50))
down_img = cv2.imread(r'D:\Users\sachi\Traffic Detection\down.png', cv2.IMREAD_UNCHANGED)
